...
Client side hooks:
* applypatch-msg
* commit-msg — Triggered after a message has been written; can be used to automatically sign off on git commit messages we have written as shown in the sample file provided for this hook.
* fsmonitor-watchman
* post-update
* pre-applypatch
...
Page 8.3 of the git documentation goes into more details on the hooks available and how to customise them [8.3 Customizing Git — Git Hooks](https://git-scm.com/book/en/v2/Customizing-Git-Git-Hooks\))
...
Scripts triggered by Git Hooks can be written in any language but script files must be named the hook and have no extension(pre-commit, post-commit) and be marked executable,
...
GIT_AUTHOR_DATE Contains the date a commit was authored. Same as above.

This website provides further detailed information about the different environment variables used by git and variables set by hooks: [Digital Ocean - How to use git hooks to automate development and deployment tasks](https://www.digitalocean.com/community/tutorials/how-to-use-git-hooks-to-automate-development-and-deployment-tasks)
...
I believe we could use Git Hooks for running tests and style engines on code before committing as well as automatically adding signing off lines to git messages or styling git messages. However, I found the following information regarding client side hooks quite alarming:
...
The official [Git Documentation](https://git-scm.com/book/en/v2/Customizing-Git-Git-Hooks) and the sample files provided with git init.
